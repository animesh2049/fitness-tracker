...
class TimerService : LifecycleService() {
    private val controller: TimerController get() = (application as FitnessApplication).container.timer
    ...
    private fun acquireWakeLock() {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "fitnesstracker:timer").apply { acquire(30 * 60 * 1000L) }
    }
    ...
    companion object {
        ...
        const val ACTION_START = "com.animesh.fitnesstracker.timer.START"
        const val ACTION_ADD = "com.animesh.fitnesstracker.timer.ADD"
        const val ACTION_SKIP = "com.animesh.fitnesstracker.timer.SKIP"
    }
}
